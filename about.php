...
<div class="slogan">
	...
	<p class="quote quote-phrase">It's SimpOoly delightful to meet you!</p>

</div>
</div>
</section>

<section class="flex-container philosophy">
	<div class="section-half half-box primary flex-container flex-item-1">
		<div  class="inner">
			<!-- <i class="fa fa-cog fa-5x fa-fw" aria-hidden="true"></i> -->
			<h4 class="quote" style="color: white">Simple</h4>
		</div>
	</div>
	<div class="section-half half-box sec-border flex-item-2">
	...
	<div class="section-half half-box sec-border flex-item-3">
		<div class="border flex-container">
			<div class="inner">
	...
	<div class="section-half half-box primary flex-container flex-item-4">
		<div class="inner">
			<!-- <i class="fa fa-puzzle-piece fa-5x fa-fw" aria-hidden="true"></i> -->
			<h4 class="quote" style="color: white">Skillful</h4>
		</div>
	</div>
	<div class="section-half half-box primary flex-container flex-item-5">
		<div class="inner">
		<!-- 	<i class="far fa-lightbulb fa-5x fa-fw" aria-hidden="true"></i> -->
			<h4 class="quote" style="color: white">Original</h4>
		</div>
	</div>
	<div class="section-half half-box sec-border flex-item-6">
		<div class="border flex-container">
			<div class="inner">
...
<section class="flex-container philosophy">
	...
	<div class="section-half">
		<div class=" flex-container">
				         ...
				         <div class="container">
				             <h3 class="new">Treehouse Certificates</h3>
 ...
 <div class="simplicity">
             ...
             <button type="button" class="btn btn-secondary"><a href="about.php">View More</a></button>
     </div>
 </section> -->
...
<section class="secton-half">
	<div class="container">
		<div>
			<i class="fa fa-lightbulb-o fa-5x fa-fw" aria-hidden="true"></i>
			<h4>Original</h4>
			<p>Simple doesn't mean boring, it means you have more room to make a <b>big splash!</b> You can choose to be different from your competitors, to promote your products and services that will catch people's eyes and bring in business.</p>
		</div>
	</div>
